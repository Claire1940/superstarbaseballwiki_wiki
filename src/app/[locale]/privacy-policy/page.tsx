...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Superstar Baseball Wiki',
    description: 'Superstar Baseball Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Superstar Baseball Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Superstar Baseball Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Superstar Baseball Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation or the developers of Superstar Baseball. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@superstarbaseballwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@superstarbaseballwiki.wiki</a>
            </p>
            <p>
