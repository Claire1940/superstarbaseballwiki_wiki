...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Superstar Baseball Wiki',
    description: 'Copyright and intellectual property information for Superstar Baseball Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Superstar Baseball Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Superstar Baseball Wiki',
      description: 'Copyright and intellectual property information for Superstar Baseball Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Superstar Baseball Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Superstar Baseball Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Superstar Baseball Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Superstar Baseball Developers</strong> - Creators of the Superstar Baseball game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Superstar Baseball</strong> - Trademark of the game developers</li>
              <li><strong>Superstar Baseball Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Superstar Baseball Wiki.
            </p>
            ...
            <p>
              ...
              Superstar Baseball Wiki<br />
              Email: <a href="mailto:dmca@superstarbaseballwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@superstarbaseballwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Superstar Baseball Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Superstar Baseball Wiki (superstarbaseballwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@superstarbaseballwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@superstarbaseballwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@superstarbaseballwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@superstarbaseballwiki.wiki</a>
            </p>
            <p>
