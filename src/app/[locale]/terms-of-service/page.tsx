...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.superstarbaseballwiki.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Superstar Baseball Wiki",
    description: "Read the Terms of Service for Superstar Baseball Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    keywords: [
      'terms of service',
      "Superstar Baseball Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      siteName: "Superstar Baseball Wiki",
      title: "Terms of Service - Superstar Baseball Wiki",
      description: "Terms and conditions for using Superstar Baseball Wiki.",
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: "Superstar Baseball Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Superstar Baseball Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Superstar Baseball Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Superstar Baseball Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Superstar Baseball Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Superstar Baseball". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Superstar Baseball Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox or the developers of Superstar Baseball. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Superstar Baseball Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Superstar Baseball. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Roblox game updates may change without notice. We are not responsible for game access or changes.</li>
            </ul>
            <p>
            ...
            <p>
              ...
              you and Superstar Baseball Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@superstarbaseballwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@superstarbaseballwiki.wiki</a>
            </p>
            <p>
